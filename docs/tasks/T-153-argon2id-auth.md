...
**APPROVE, own session** (not wave-2): vendored argon2 + ADR-0012 + schema v15
+ rehash-on-login. Security-sensitive + network fetch = exactly one card.
Rationale in `T-WAVE2-EPOCH30.md`.
