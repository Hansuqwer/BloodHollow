...
**(B) five stats.** Implement inside wave-2 (`T-WAVE2-EPOCH30.md`): INT/MAG
assignable, aura radius hard-coded 12, pledge gate stays L≥10+10k, CHA struck
with ADR + change-control note. Rationale in wave-2 card.
