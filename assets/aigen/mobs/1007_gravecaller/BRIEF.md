...
**Cell / sheet:** 32×48 (body 44 px) · 10 cols × 8 rows = 320×384
**Palette family:** `choir-wax` (shared strip; build with `bhpix.build_palette` over the whole family first)
...
Name collides with the player class; folder keeps the content-table name. The mob has *no face* under the mask; the player class wears a half-mask.
