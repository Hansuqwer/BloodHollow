...
**Cell / sheet:** 32×48 (body 20 px) · walk4+attack3+die3 → 10 cols × 8 rows = 320×384
**Palette family:** `vermin` (shared strip; build with `bhpix.build_palette` over the whole family first)
...
B0 plate already exists: `docs/research-notes/style-tile/plates/marsh_rat_4x_raw.png` (reuse as the S/SE source).
