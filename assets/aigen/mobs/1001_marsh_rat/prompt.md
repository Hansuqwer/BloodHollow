...
SUBJECT  = "Marsh Rat, swollen drowned rat, matted spiked wet fur, bloated grey-pink belly, black ichor drool, naked tail, low skitter, 3/4 south-facing, sickly pathetic, single creature, feet on ground"
...
## Cell / sheet
32×48 (body 20 px) · walk4+attack3+die3 → 10 cols × 8 rows = 320×384

## Runs
- SE · 2026-09-07 · Arena Agent Mode image generation, model **undisclosed** (provider-abstracted) · seed n/a · B0 plate `style-tile/plates/marsh_rat_4x_raw.png` reused (copied to `plates/marsh_rat_SE_4x_raw.png`) · accepted **y** (B3 first pass)
- S · 2026-09-08 · Arena Agent Mode image generation, model **undisclosed** (provider-abstracted) · seed n/a · new generation, prompt.md PREFIX+SUBJECT, pose line "facing south" · accepted **y** (B3 first pass)
