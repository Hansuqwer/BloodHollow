...
**Cell / sheet:** 32×48 (body 46 px; halberd may exit top by 2 px) · 10 cols × 8 rows = 320×384
**Palette family:** `grave-goods` (shared strip; build with `bhpix.build_palette` over the whole family first)
...
SUBJECT = "Revenant Sexton, armoured undead gravekeeper, rusted plate over grave cloth, holding a rusted spade-bladed halberd upright, iron key ring on the belt, cold grey-pink face under a hood, heavy dragging stance, 3/4 south-facing, single figure"
