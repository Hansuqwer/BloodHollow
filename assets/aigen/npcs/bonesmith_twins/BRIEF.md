# The Bonesmith twins — anvil priestesses (kind 67, reserved)
...
**Cell / sheet:** 64×48 (both in one cell) · idle4 × 8 dirs = 256×384 + portrait 96×96
**Palette family:** `npc-ember` (shared strip; build with `bhpix.build_palette` over the whole family first)
...
SUBJECT = "two soot-veiled sisters flanking a black anvil, left holds a hammer, right holds tongs, ember rim light on the veil edges, dark robes, standing idle, full body"
