# prompt.md — Chapel Confessor (kind 68, reserved)
...
SUBJECT  = "gaunt kind priest in ash-grey robe, nail-through-leaf sigil on the stole, nailed-plank prayer board under one arm, soot on the fingers, standing idle, full body"
