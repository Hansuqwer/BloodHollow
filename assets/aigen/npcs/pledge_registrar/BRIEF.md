# Pledge Registrar — Marrowgate (kind 72, reserved)
...
**Palette family:** `npc-synod` (shared strip; build with `bhpix.build_palette` over the whole family first)
...
SUBJECT = "thin zealot clerk in bone-white robe, incense-gold ink stains on fingers and cuff, quill and a chained ledger, ink under the eyes like kohl, standing idle, full body"
