...
SUBJECT = "male human warrior with heavy shoulders, soot-grey padded gambeson with rusted iron plates nailed on, butcher-chain belt with iron hooks, oversized notched cleaver-axe held low in the right hand (15 percent oversized), pale scarred skin, close-cropped dark hair, grim, standing idle, full body"
...
B0 plate exists for the male Ravager: `docs/research-notes/style-tile/plates/ravager_4x_raw.png`.
