# Cultist of the Pale Choir — female base (cultist/f)
...
**Palette family:** `player-cultist (3 skin-tone swaps: pale, sallow, weathered-tan)` (shared strip; build with `bhpix.build_palette` over the whole family first)
