# Gravecaller — female base (gravecaller/f)
...
**Palette family:** `player-gravecaller (3 skin-tone swaps: pale, sallow, weathered-tan)` (shared strip; build with `bhpix.build_palette` over the whole family first)
