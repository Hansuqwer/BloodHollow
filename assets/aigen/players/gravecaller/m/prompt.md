...
- 2026-09-17 · flux (black-forest-labs/flux.1-schnell via gen.pollinations.ai, 512x768) · probe gravecaller_m_S (hardened chroma wording: solid flat pure-green chroma-key RGB 0,255,0 backdrop, no ground, no shadow, 16-bit pixel sprite) · REJECTED: green_frac 0.018, corner #398634 not #00FF00, painterly still; quarantined to /tmp/probe_gravecaller_m_S.jpg (md5 24ddf6ee), not in plates/; 1/10 turn consumed, 9 remain — probe-before-batch holds, no batch until probe passes
