# Weeping Castle kit (post-MVP, design only)
...
**Contents:** plates: ashlar, wall-walk · gate 3 states · Heartstone 64×96 · throne dais · banner poles + recolour mask · sconces
...
- One palette strip ≤ 32 colours for the whole tileset (`palette_castle.png`).
