...
inline constexpr KitDef kKits[] = {
    ...
    {kKitRavager, "Ravager", 8, 8, 8, 0, 0, {0, 1, 0, 0, 0, 0}},
    {kKitGravecaller, "Gravecaller", 6, 6, 6, 4, 2, {0, 0, 0, 0, 0, 1}},
    {kKitCultist, "Pale Choir", 5, 8, 5, 3, 3, {0, 1, 1, 3, 6, 0}},
};
